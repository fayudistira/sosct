<?php
$admissionsFile = 'public/test_admissions.php';
$invoicesFile = 'public/test_invoices.php';
...
file_put_contents($invoicesFile, $html);
echo "Created test file at: " . $invoicesFile . "\n";
