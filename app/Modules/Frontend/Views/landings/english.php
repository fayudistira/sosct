...
<div class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: #457b9d;">Daftar Lengkap Program Inggris</h2>
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        ...
                                                                        <div class="d-flex gap-2">
                                                                            ...
                                                                            <a href="<?= base_url('apply/' . $program['id']) ?>" class="btn btn-primary btn-sm fw-bold">
                                                                                Apply
                                                                            </a>
                                                                        </div>
                                                                    </div>
