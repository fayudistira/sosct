 ...
 * 
 * Page-specific SEO and content for Japanese language course
 */

// Page-specific variables for SEO
$pageTitle = 'Kursus Bahasa Jepang Terbaik di Kampung Inggris Pare | SOS Course';
$pageDescription = 'SOS Course & Training adalah kursus bahasa Jepang terbaik di Kampung Inggris Pare, Kediri. Program Reguler, Semi-Privat, dan Privat dengan tutor berpengalaman. Program persiapan JLPT N5-N1 dan studi ke Jepang.';
$pageKeywords = 'kursus bahasa jepang pare, kampung inggris pare, les bahasa jepang kediri, belajar bahasa jepang di pare, kursus bahasa jepang bersertifikat, jlpt, test bahasa jepang, studi jepang,beasiswa jepang, mext, sos course jepang';
$ogImage = 'https://images.pexels.com/photos/2506923/pexels-photo-2506923.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2';
?>

<?= $this->extend('Modules\Frontend\Views\layout') ?>

<?= $this->section('extra_head') ?>
<!-- Page-specific styles for Japanese landing -->
<style>
    ...
    /* Language Header Tabs - Red/Pink Background */
    .btn-lang-header {
        display: inline-flex;
        align-items: center;
...
<!-- Hero Section -->
<div class="hero-section position-relative overflow-hidden py-5" style="min-height: 65vh; background: linear-gradient(135deg, #ff6b9d 0%, #ff4777 100%);">
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                <div class="d-flex align-items-center gap-3 mb-4">
                    <img src="https://flagcdn.com/w80/jp.png" alt="Japan Flag" class="rounded shadow-sm" width="60" height="40">
                    <div class="badge bg-white text-pink p-2 px-3 rounded-pill shadow-sm fw-bold" style="color: #ff6b9d;">
                        SOS Course & Training
                    </div>
                </div>
                <h1 class="display-3 fw-bold mb-3 text-white">
                    Kursus Bahasa Jepang Terbaik di Pare
                </h1>
                <p class="lead mb-4 text-white-90" style="font-size: 1.15rem;">
                    Wujudkan mimpi studi dan kerja di Jepang. Kursus bahasa Jepang dengan program persiapan JLPT dan metode pengajaran intensif.
                </p>
                <div class="d-flex flex-wrap gap-3">
                    <a href="https://wa.me/6282240781299?text=Hai,%20saya%20tertarik%20dengan%20kursus%20Bahasa%20Jepang"
                        target="_blank"
                        class="btn btn-white btn-lg px-4 shadow fw-bold" style="color: #ff6b9d;">
            ...
            <div class="col-lg-5">
                <div class="bg-white rounded-5 p-5 text-dark shadow-lg">
                    ...
                    <div class="display-4 fw-bold mb-3" style="color: #ff6b9d;">Tanggal 10</div>
                    <p class="mb-0 text-muted">Tiap bulannya</p>
                    <hr class="my-4">
                    <div class="d-flex align-items-center gap-3">
                        <i class="bi bi-award fs-1" style="color: #ff6b9d;"></i>
                        <div>
...
<div class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: #ff6b9d;">Daftar Lengkap Program Bahasa Jepang</h2>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-end">
                                                                                <?php if (!empty($program['discount']) && $program['discount'] > 0): ?>
                                                                                    ...
                                                                                    <div class="fw-bold" style="color: #ff6b9d;">Rp <?= number_format($finalPrice, 0, ',', '.') ?></div>
                                                                                <?php else: ?>
                                                                            ...
                                                                            <td class="text-center">
                                                                                <div class="d-flex gap-2 justify-content-center">
                                                                                    ...
                                                                                    <a href="<?= base_url('apply/' . $program['id']) ?>" 
                                                                                        class="btn btn-pink btn-sm rounded px-3 fw-bold" style="background: #ff6b9d; color: white; border-color: #ff6b9d;">
                                                                                        Apply
                                                                                    </a>
                                                                                </div>
                                                                            </td>
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div>
                                                                        <?php if (!empty($program['discount']) && $program['discount'] > 0): ?>
                                                                            ...
                                                                            <span class="fw-bold ms-1" style="color: #ff6b9d;">Rp <?= number_format($finalPrice, 0, ',', '.') ?></span>
                                                                        <?php else: ?>
                                                            ...
                                                            <div class="mt-3 pt-3 border-top">
                                                                <div class="d-grid gap-2">
                                                                    ...
                                                                    <div class="d-flex gap-2">
                                                                        ...
                                                                        <a href="<?= base_url('apply/' . $program['id']) ?>" 
                                                                            class="btn btn-sm rounded flex-fill fw-bold" style="background: #ff6b9d; color: white; border-color: #ff6b9d;">
                                                                            Apply
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="d-flex gap-2 justify-content-center">
                                                                        ...
                                                                        <a href="<?= base_url('apply/' . $program['id']) ?>" 
                                                                            class="btn btn-sm rounded px-3 fw-bold" style="background: #ff6b9d; color: white; border-color: #ff6b9d;">
                                                                            Apply
                                                                        </a>
                                                                    </div>
                                                                </td>
                                            ...
                                            <div class="mobile-program-card">
                                                ...
                                                <div class="mt-3 pt-3 border-top">
                                                    <div class="d-grid gap-2">
                                                        ...
                                                        <a href="<?= base_url('apply/' . $program['id']) ?>" 
                                                            class="btn btn-sm rounded fw-bold" style="background: #ff6b9d; color: white; border-color: #ff6b9d;">
                                                            Apply
                                                        </a>
                                                    </div>
                                                </div>
...
<div class="container py-5">
    <div class="text-center mb-5">
        <h2 class="display-5 fw-bold mb-3" style="color: #ff6b9d;">Mengapa Belajar Bahasa Jepang?</h2>
        <p class="lead text-muted">Jepang adalah negara maju dengan banyak peluang menarik.</p>
    </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    <div class="feature-icon-pink mb-3">
                        <i class="bi bi-globe"></i>
                    </div>
                    <h5 class="fw-bold mb-3">Ekonomi Terbesar</h5>
                    <p class="text-muted small mb-0">Jepang adalah negara maju dengan ekonomi terbesar ketiga di dunia.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <p class="text-muted small mb-0">Peluang kerja di teknologi, industri, kesehatan, dan hospitality.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Beasiswa MEXT</h5>
                    <p class="text-muted small mb-0">Banyak beasiswa dari pemerintah Jepang termasuk program MEXT.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Budaya Populer</h5>
                    <p class="text-muted small mb-0">Akses langsung ke anime, drama, dan budaya Jepang tanpa subtitle.</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- 7 Reasons Section -->
<div class="py-5" style="background: linear-gradient(180deg, #fff0f5 0%, #fff 100%);">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: #ff6b9d;">Mengapa Harus SOS Course Japanese?</h2>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-0">Siswa diajarkan dari dasar - mulai dari Hiragana, Katakana, sampai Kanji.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-0">Tutor berpengalaman dengan metode pengajaran yang proven efektif.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Persiapan JLPT</h5>
                        <p class="text-muted small mb-0">Persiapan ujian JLPT dari N5 sampai N1 dengan simulasi tes.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Budaya Jepang</h5>
                        <p class="text-muted small mb-0">Pemahaman budaya Jepang yang mendalam untuk komunikasi lebih baik.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Bantuan Studi Jepang</h5>
                        <p class="text-muted small mb-0">Bantuan informasi dan bimbing untuk studi ke Jepang.</p>
                    </div>
                </div>
            </div>
...
<div class="container py-5">
    <div class="row align-items-center g-5">
        <div class="col-lg-6">
            <h2 class="display-5 fw-bold mb-4" style="color: #ff6b9d;">Tentang Kursus Bahasa Jepang SOS</h2>
            <p class="text-muted mb-4">
                SOS Course & Training adalah lembaga kursus bahasa Jepang terbaik yang berlokasi di <strong>Kampung Inggris Pare, Kediri</strong>, Jawa Timur.
            </p>
            <p class="text-muted mb-4">
                Kami membantu Anda mewujudkan mimpi untuk belajar atau bekerja di Jepang. Metode pengajaran kami fokus pada pendekatan komunikatif dan praktis.
            </p>
            <p class="text-muted mb-4">
                Kami menawarkan berbagai pilihan program: Reguler, Semi-Privat, dan Privat dengan fokus pada persiapan JLPT.
            </p>
            <div class="d-flex align-items-center gap-3 flex-wrap">
                <div class="text-white rounded-4 px-4 py-3 text-center" style="background: linear-gradient(135deg, #ff6b9d 0%, #ff4777 100%);">
                    <div class="h4 fw-bold mb-0">JLPT</div>
                    <small>N5-N1</small>
                </div>
                <div class="text-white rounded-4 px-4 py-3 text-center" style="background: linear-gradient(135deg, #ff6b9d 0%, #ff4777 100%);">
                    <div class="h4 fw-bold mb-0">Hiragana</div>
                    <small>Katakana</small>
                </div>
                <div class="text-white rounded-4 px-4 py-3 text-center" style="background: linear-gradient(135deg, #ff6b9d 0%, #ff4777 100%);">
                    <div class="h4 fw-bold mb-0">Kanji</div>
                    <small>Dasar-Lanjut</small>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="bg-gradient-pink rounded-5 p-5 text-white shadow-lg">
                <h3 class="fw-bold mb-4">Program Dimulai</h3>
...
<div class="py-5 bg-gradient-pink text-white">
    <div class="container text-center py-5">
        <h2 class="display-5 fw-bold mb-3">Wujudkan Mimpi ke Jepang!</h2>
        <p class="lead mb-4 opacity-75">Jepang menanti Anda. Mulai perjalanan bahasa Jepang Anda hari ini!</p>

        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="https://wa.me/6282240781299?text=Hai,%20saya%20tertarik%20dengan%20kursus%20Bahasa%20Jepang"
                target="_blank"
                class="btn btn-white btn-lg px-5 shadow fw-bold" style="color: #ff6b9d;">
