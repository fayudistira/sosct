...
$pageTitle = 'Kursus Bahasa Jepang Kampung Inggris Pare - SOS Course | JLPT';
$pageDescription = 'Kursus Bahasa Jepang terbaik di Kampung Inggris Pare, Kediri. Spesialis JLPT N5-N1. Persiapan kerja dan kuliah di Jepang dengan native speaker.';
$pageKeywords = 'kursus bahasa jepang pare, Kampung Inggris Pare, les jepang kediri, kursus jepang pare, belajar jepang di pare, kursus bahasa jepang bersertifikat, jlpt pare, kerja di jepang, kuliah jepang, sos course';
$ogImage = 'https://images.pexels.com/photos/5031312/pexels-photo-5031312.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2';
?>
...
<style>
    ...
    /* Language Header Tabs - Red Background */
    .btn-lang-header {
        display: inline-flex;
        align-items: center;
...
<div class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: #e63946;">Daftar Lengkap Program Jepang</h2>
                                                                            ...
                                                                            <td class="text-center">
                                                                                <div class="d-flex gap-2 justify-content-center">
                                                                                    ...
                                                                                    <a href="<?= base_url('apply/' . $program['id']) ?>" 
                                                                                        class="btn btn-danger btn-sm rounded px-3 fw-bold">
                                                                                        Apply
                                                                                    </a>
                                                                                </div>
                                                                            </td>
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        ...
                                                                        <div class="d-flex gap-2">
                                                                            ...
                                                                            <a href="<?= base_url('apply/' . $program['id']) ?>" class="btn btn-danger btn-sm fw-bold">
                                                                                Apply
                                                                            </a>
                                                                        </div>
                                                                    </div>
...
<!-- 7 Reasons Section -->
<div class="py-5" style="background: linear-gradient(180deg, #fff5f5 0%, #fff 100%);">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: #e63946;">Mengapa Harus SOS Course?</h2>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Ekonomi Besar Dunia</h5>
                        <p class="text-muted small mb-0">Jepang adalah ekonomi terbesar ke-3 di dunia dengan banyak peluang kerja.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Beasiswa MEXT</h5>
                        <p class="text-muted small mb-0">Persiapan lengkap untuk mendapatkan beasiswa MEXT dan kuliah di Jepang.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-0">Banyak perusahaan Jepang yang membutuhkan tenaga kerja Indonesia.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-0">Pengajar native speaker Jepang untuk pronunciation yang benar.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-0">Program intensif hingga 5x pertemuan per hari untuk progres lebih cepat.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Sertifikat JLPT</h5>
                        <p class="text-muted small mb-0">Sertifikasi JLPT yang diakui resmi oleh pemerintah Jepang.</p>
                    </div>
                </div>
            </div>
...
<div class="container py-5">
    <div class="row align-items-center g-5">
        <div class="col-lg-6">
            <h2 class="display-5 fw-bold mb-4" style="color: #e63946;">Tentang Kursus Bahasa Jepang SOS Course</h2>
            <p class="text-muted mb-4">
                SOS Course and Training adalah lembaga kursus bahasa Jepang terbaik di <strong>Kampung Inggris Pare</strong>, Kediri Jawa Timur yang telah berdiri sejak tahun 2013.
            </p>
            <p class="text-muted mb-4">
                Kami adalah pusat pembelajaran bahasa Jepang yang spesialis untuk persiapan JLPT (Japanese-Language Proficiency Test) dari level N5 hingga N1. Programs kami juga mencakup persiapan bekerja dan kuliah di Jepang.
            </p>
            <p class="text-muted mb-4">
                Dengan pengajar native speaker Jepang dan kurikulum yang disesuaikan dengan standar JLPT, kami siap membantu Anda seringk memahami bahasa Jepang dan lulus JLPT dengan nilai tinggi.
            </p>
            <div class="d-flex align-items-center gap-3 flex-wrap">
                ...
                <div class="bg-danger text-white rounded-4 px-4 py-3 text-center">
                    <div class="h4 fw-bold mb-0">J-TEST</div>
        ...
        <div class="col-lg-6">
            <div class="bg-gradient-danger rounded-5 p-5 text-white shadow-lg">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="fw-bold">Bantuan Karir</div>
                        <small class="opacity-75">Kerja di Jepang</small>
                    </div>
                </div>
            </div>
        </div>
