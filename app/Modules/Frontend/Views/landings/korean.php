...
$pageTitle = 'Kursus Bahasa Korea Terbaik di Kampung Inggris Pare | SOS Course';
$pageDescription = 'SOS Course & Training adalah kursus bahasa Korea terbaik di Kampung Inggris Pare, Kediri. Kursus Bahasa Korea dengan program persiapan TOPIK. Belajar K-Pop, K-Drama, dan bahasa Korea praktis.';
$pageKeywords = 'kursus bahasa korea pare, kampung inggris pare, les bahasa korea kediri, belajar bahasa korea di pare, kursus bahasa korea bersertifikat, topik, test bahasa korea, studi korea,beasiswa korea, k-pop, sos course korea';
$ogImage = 'https://images.pexels.com/photos/3402853/pexels-photo-3402853.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2';
?>
...
<style>
    ...
    /* Language Header Tabs - Blue/Cyan Background */
    .btn-lang-header {
        display: inline-flex;
        align-items: center;
...
<!-- Hero Section -->
<div class="hero-section position-relative overflow-hidden py-5" style="min-height: 65vh; background: linear-gradient(135deg, #00d4ff 0%, #0099cc 100%);">
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                <div class="d-flex align-items-center gap-3 mb-4">
                    <img src="https://flagcdn.com/w80/kr.png" alt="Korea Flag" class="rounded shadow-sm" width="60" height="40">
                    <div class="badge bg-white text-info p-2 px-3 rounded-pill shadow-sm fw-bold">
                        SOS Course & Training
                    </div>
                </div>
                <h1 class="display-3 fw-bold mb-3 text-white">
                    Kursus Bahasa Korea Terbaik di Pare
                </h1>
                <p class="lead mb-4 text-white-90" style="font-size: 1.15rem;">
                    Belajar bahasa Korea dengan fun! Kursus Korea untuk любителей K-Pop, K-Drama, dan persiapan TOPIK.
                </p>
                <div class="d-flex flex-wrap gap-3">
                    <a href="https://wa.me/6282240781299?text=Hai,%20saya%20tertarik%20dengan%20kursus%20Bahasa%20Korea"
                        target="_blank"
                        class="btn btn-white btn-lg px-4 shadow fw-bold" style="color: #00d4ff;">
            ...
            <div class="col-lg-5">
                <div class="bg-white rounded-5 p-5 text-dark shadow-lg">
                    ...
                    <div class="display-4 fw-bold mb-3" style="color: #00d4ff;">Tanggal 10</div>
                    <p class="mb-0 text-muted">Tiap bulannya</p>
                    <hr class="my-4">
                    <div class="d-flex align-items-center gap-3">
                        <i class="bi bi-award fs-1" style="color: #00d4ff;"></i>
                        <div>
...
<div class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: #00d4ff;">Daftar Lengkap Program Bahasa Korea</h2>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-end">
                                                                                <?php if (!empty($program['discount']) && $program['discount'] > 0): ?>
                                                                                    ...
                                                                                    <div class="fw-bold" style="color: #00d4ff;">Rp <?= number_format($finalPrice, 0, ',', '.') ?></div>
                                                                                <?php else: ?>
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div>
                                                                        <?php if (!empty($program['discount']) && $program['discount'] > 0): ?>
                                                                            ...
                                                                            <span class="fw-bold ms-1" style="color: #00d4ff;">Rp <?= number_format($finalPrice, 0, ',', '.') ?></span>
                                                                        <?php else: ?>
...
<div class="container py-5">
    <div class="text-center mb-5">
        <h2 class="display-5 fw-bold mb-3" style="color: #00d4ff;">Mengapa Belajar Bahasa Korea?</h2>
        <p class="lead text-muted">Korea Selatan adalah negara maju dengan budaya yang semakin populer.</p>
    </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    <div class="feature-icon-cyan mb-3">
                        <i class="bi bi-music-note-beamed"></i>
                    </div>
                    <h5 class="fw-bold mb-3">K-Pop & K-Drama</h5>
                    <p class="text-muted small mb-0">Nikmati musik dan drama Korea tanpa subtitle.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <p class="text-muted small mb-0">Peluang kerja di teknologi, manufaktur, dan hiburan.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Beasiswa Korea</h5>
                    <p class="text-muted small mb-0">Banyak beasiswa dari pemerintah dan universitas Korea.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Bahasa Muda</h5>
                    <p class="text-muted small mb-0">Sistem penulisan Hangul mudah dipelajari dalam waktu singkat.</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- 7 Reasons Section -->
<div class="py-5" style="background: linear-gradient(180deg, #f0fbff 0%, #fff 100%);">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: #00d4ff;">Mengapa Harus SOS Course Korean?</h2>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-0">Siswa diajarkan dari dasar - mulai dari Hangul sampai percakapan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Persiapan TOPIK</h5>
                        <p class="text-muted small mb-0">Persiapan ujian TOPIK dari level 1 sampai 6.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-2">Fun Learning</h5>
                        <p class="text-muted small mb-0">Belajar sambil menikmati budaya K-Pop dan K-Drama.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift bg-white">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-0">Kerja sama dengan berbagai institusi dan perusahaan Korea.</p>
                    </div>
                </div>
            </div>
...
<div class="container py-5">
    <div class="row align-items-center g-5">
        <div class="col-lg-6">
            <h2 class="display-5 fw-bold mb-4" style="color: #00d4ff;">Tentang Kursus Bahasa Korea SOS</h2>
            <p class="text-muted mb-4">
                SOS Course & Training adalah lembaga kursus bahasa Korea terbaik yang berlokasi di <strong>Kampung Inggris Pare, Kediri</strong>, Jawa Timur.
            </p>
            <p class="text-muted mb-4">
                Kami membantu Anda mempelajari bahasa Korea dengan fun dan efektif. Metode pengajaran kami fokus pada pendekatan komunikatif dan praktis.
            </p>
            <p class="text-muted mb-4">
                Kami menawarkan berbagai pilihan program: Reguler, Semi-Privat, dan Privat dengan fokus pada persiapan TOPIK.
            </p>
            <div class="d-flex align-items-center gap-3 flex-wrap">
                <div class="text-white rounded-4 px-4 py-3 text-center" style="background: linear-gradient(135deg, #00d4ff 0%, #0099cc 100%);">
                    <div class="h4 fw-bold mb-0">TOPIK</div>
                    <small>I-II</small>
                </div>
                <div class="text-white rounded-4 px-4 py-3 text-center" style="background: linear-gradient(135deg, #00d4ff 0%, #0099cc 100%);">
                    <div class="h4 fw-bold mb-0">Hangul</div>
                    <small>Dasar</small>
                </div>
                <div class="text-white rounded-4 px-4 py-3 text-center" style="background: linear-gradient(135deg, #00d4ff 0%, #0099cc 100%);">
                    <div class="h4 fw-bold mb-0">Conversation</div>
                    <small>Pemula-Lanjut</small>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="bg-gradient-cyan rounded-5 p-5 text-white shadow-lg">
                <h3 class="fw-bold mb-4">Program Dimulai</h3>
...
<div class="py-5 bg-gradient-cyan text-white">
    <div class="container text-center py-5">
        <h2 class="display-5 fw-bold mb-3">Belajar Bahasa Korea Sekarang!</h2>
        <p class="lead mb-4 opacity-75">Mulai perjalanan bahasa Korea Anda hari ini dan explore dunia K-Pop, K-Drama, dan peluang karier!</p>

        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="https://wa.me/6282240781299?text=Hai,%20saya%20tertarik%20dengan%20kursus%20Bahasa%20Korea"
                target="_blank"
                class="btn btn-white btn-lg px-5 shadow fw-bold" style="color: #00d4ff;">
